...
@section('main')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">
            Daftar Surat Pesanan Penjualan
        </h2>
        <a href="detail-sp-penjualan"><button class="btn btn-primary">Tambah +</button></a>
    </div>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <div class="sm:flex gap-3 mb-3 justify-between">
                ...
                <a href="#"><button class="btn btn-success text-white">Kirim Ke Cek SP</button></a>
            </div>
